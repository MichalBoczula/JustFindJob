        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MainTechnologyName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MainTechnologyImage = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Modified = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TechnologyElement", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TechnologyElement_Technologies_TechnologyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TechnologyElement_TechnologyId",
